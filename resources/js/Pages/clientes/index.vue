...
import FichasCliente from "../core/usuarios/fichasCliente.vue";

export default {
    name: "UsuariosIndex",
    components: { FichasCliente },
    setup() {
    ...
    mounted() {
        this.store
            .cargarClientes(1, this.busqueda, this.parametro)
            .then((respuesta) => {
    ...
    methods: {
        cambiarPaginacion(pagina, busqueda, parametro) {
            this.store
                .cargarClientes(pagina, this.busqueda, this.parametro)
                .then((respuesta) => {
                    this.paginacion = respuesta;
                });
        },
        ...
        async cambiarEstado(usuario) {
            ...
            this.store.cargarClientes(1, this.busqueda, this.parametro);
        },
