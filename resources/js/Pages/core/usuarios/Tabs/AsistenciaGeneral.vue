<template>
            ...
            <tbody>
                ...
                >
                    <td
                        ...
                        :class="{
                            'bg-light-info':
                                asistencia.fecha_hora_entrada !== null,
                        }"
                    >
                        <div
    ...
    >
        <Message severity="info" :closable="false"
            >El registro de asistencias deben ser verificadas por un
            administrador para ser sumadas en el total global</Message
        >
...
export default {
    ...
    setup() {
        ...
        const verificarAsistencia = (event, idAsistencia) => {
            confirm.require({
                target: event.currentTarget,
                message: "¿Quieres verificar la asistencia?",
                icon: "pi pi-info-circle",
                rejectClass:
                    "p-button-secondary p-button-outlined p-button-sm me-5",
                ...
                accept: () => {
                    storeAsistencias
                        .verificarAsistencia(idAsistencia)
                        .then(() => {
                            storeAsistencias.obtenerAsistencias(
                                storeUsuarios.usuario.id,
                                storeEventos.eventoPrincipal.id,
                            ...
                            toast.add({
                                severity: "success",
                                summary: "Confirmado",
                                detail: "Asistencia Verificada con éxito",
                                life: 3000,
                            });
                        });
                },
    ...
    mounted() {
        if (this.usuario) {
            this.storeUsuarios.obtenerUsuario(this.usuario);
        }
