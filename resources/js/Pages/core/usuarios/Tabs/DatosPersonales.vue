<template>
  <form action="">
    <div
      :class="['d-flex w-100 gap-5', esResponsivo ? 'flex-column' : 'flex-row']"
    >
      <div class="flex-grow-1">
        ...
        >
          <div class="d-flex flex-grow-1 flex-column gap-2 mb-5">
            ...
            <small
              class="text-danger"
              v-if="enviado || v$?.usuarioData.persona.paterno.$error"
          ...
          <div class="d-flex flex-grow-1 flex-column gap-2 mb-5">
            ...
            <small
              class="text-danger"
              v-if="enviado || v$?.usuarioData.persona.materno.$error"
        ...
        >
          ...
          <div class="d-flex flex-grow-1 flex-column gap-2 mb-5">
            ...
            <small
              class="text-danger"
              v-if="enviado || v$?.usuarioData.persona.telefono.$error"
        ...
        <div class="d-flex flex-column gap-2 mb-5">
          ...
          <small
            class="text-danger"
            v-if="enviado || v$?.usuarioData.persona.direccion.$error"
      ...
      <div v-if="this.store.usuario.personal" class="flex-grow-1">
        ...
        <div class="d-flex flex-column gap-2 mb-5">
          ...
          <small
            class="text-danger"
            v-if="enviado || v$?.usuarioData.personal.universidad.$error"
        ...
        <div class="d-flex flex-column gap-2 mb-5">
          ...
          <small
            class="text-danger"
            v-if="enviado || v$?.usuarioData.personal.facultad.$error"
        ...
        <div class="d-flex flex-column gap-2 mb-5">
          ...
          <small
            class="text-danger"
            v-if="enviado || v$?.usuarioData.personal.carrera.$error"
