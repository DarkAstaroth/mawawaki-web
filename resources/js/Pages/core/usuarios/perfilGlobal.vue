<template>
    <div id="kt_app_content" class="app-content flex-column-fluid">
        ...
        this.usuario.persona.paterno }} {{
        this.usuario.persona.materno }}</a>
                                        <a href="#">
                                    ...
                                    <div class="d-flex flex-wrap">
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="2"
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="40"
                                                    data-kt-countup-prefix="">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
                                        ...
                                        <div
                                            ...
                                            <div class="d-flex align-items-center justify-content-center">
                                                ...
                                                <div class="fs-2 fw-bold" data-kt-countup="true" data-kt-countup-value="35"
                                                    data-kt-countup-prefix="">0</div>
                                            </div>
                                            <!--end::Number-->
                                            <!--begin::Label-->
