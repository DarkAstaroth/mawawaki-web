<template>
    <FichasActividades :usuario="this.usuario" />
            ...
            <nav>
                <ul class="pagination">
                    <li
                        ...
                        :class="{
                            disabled:
                                this.store.paginacion.actividades
                                    .paginaActual === 1,
                        }"
                    >
                        <a
                    ...
                    <li
                        class="page-item"
                        v-for="page in this.store.paginacion.actividades
                            .ultimaPagina"
                        :key="page"
                        :class="{
                            active:
                    ...
                    <li
                        ...
                        :class="{
                            disabled:
                                this.store.paginacion.actividades
                                    .paginaActual ===
                                this.store.paginacion.actividades.ultimaPagina,
                        }"
                    >
                        <a
                            class="page-link"
...
import FichasActividades from "./fichasActividades.vue";

export default {
    name: "ActividadesUsuario",
    components: { FichasActividades },
    props: ["usuario"],
    data() {
        return {
            busqueda: "",
