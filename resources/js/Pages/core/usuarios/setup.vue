    ...
    <div>
        <div class="stepper stepper-pills" id="kt_stepper_example_basic">
            <div class="stepper-nav flex-center flex-wrap mb-10">
                <div class="stepper-item mx-8 my-4" :class="{ current: pasoActivo === 0 }" data-kt-stepper-element="nav">
                ...
                <div class="stepper-item mx-8 my-4" :class="{ current: pasoActivo === 1 }" data-kt-stepper-element="nav">
                    <div class="stepper-wrapper d-flex align-items-center">
                        <div class="stepper-icon w-40px h-40px">
                            <i class="stepper-check fas fa-check"></i>
            ...
            <div v-if="pasoActivo === 0">
                <div class="d-flex flex-column gap-3">
                    <input type="radio" class="btn-check" v-model="opcionSeleccionada" value="personal"
                        id="opcionPersonal" />
                    <label
                        ...
                        <span class="d-block fw-semibold text-start">
                            ...
                            <span class="text-muted fw-semibold fs-6">Administradores, Pasantes, Voluntarios, etc </span>
                        </span>
                    </label>

                    <input type="radio" class="btn-check" v-model="opcionSeleccionada" value="cliente" id="opcionCliente" />
                    <label class="btn btn-outline btn-outline-dashed btn-active-light-primary p-7 d-flex align-items-center"
                        ...
                        <span class="d-block fw-semibold text-start">
                            ...
                            <span class="text-muted fw-semibold fs-6">Pacientes del centro de terapias</span>
                        </span>
                    </label>
                </div>
            ...
            <div v-if="opcionSeleccionada && pasoActivo === 1" class="mb-10 d-grid mt-5">
                <form @submit.prevent="enviarFormulario">
                    <div v-if="opcionSeleccionada === 'personal'">
                        <input type="hidden" name="tipo" value="personal">
                        <div class="d-flex flex-column gap-2 mb-5">
                            <label for="universidad">Universidad</label>
                            <InputText id="universidad" v-model="datosPersonal.universidad" aria-describedby="universidad"
                                placeholder="Ingrese su universidad" />
                        </div>

                        <div class="d-flex flex-column gap-2 mb-5">
                            <label for="facultad">Facultad</label>
                            <InputText id="facultad" v-model="datosPersonal.facultad" aria-describedby="facultad"
                                placeholder="Ingrese su facultad" />
                        </div>

                        <div class="d-flex flex-column gap-2 mb-5">
                            <label for="facultad">Carrera</label>
                            <InputText id="facultad" v-model="datosPersonal.carrera" aria-describedby="facultad"
                                placeholder="Ingrese su facultad" />
                        </div>
                    </div>
                    <div v-else-if="opcionSeleccionada === 'cliente'">
                        ...
                        <div class="d-flex flex-column gap-2">
                            ...
                            <InputText id="ocupacion" v-model="ocupacion" aria-describedby="ayudaOcupacion"
...
export default {
    ...
    methods: {
        ...
        enviarFormulario() {
            axios.post(`/api/invitado/enviar/solicitud`, {
                tipo: this.opcionSeleccionada,
                datos: this.opcionSeleccionada === 'cliente' ? this.datosCliente : this.datosPersonal,
