            ...
            <div class="row">
                <div class="bg-center bg-cover bg-no-repeat hero-bg mb-10">
                    <div class="container-fixed">
                        ...
                        >
                            <img
                                class="rounded-full border-3 border-success w-[70px] h-[70px] shrink-0"
                                :src="'/'.concat(usuario.profile_photo_path)"
                            />
                            <div class="flex items-center gap-1.5">
                                <div
                                    class="text-lg leading-5 font-semibold text-gray-900"
                                >
                            ...
                            <div
                                class="flex flex-wrap justify-center gap-1 lg:gap-4.5 text-sm"
                            >
                                <div class="flex gap-1.25 items-center">
                                    <i
                                        class="ki-filled ki-dribbble text-gray-500 text-sm"
                                    >
                                    </i>
                ...
                <TabView>
                    <TabPanel header="Datos Personales" v-if="is('admin')">
                        <DatosPersonales />
                    </TabPanel>
                    <TabPanel header="Roles" v-if="is('admin')">
                    ...
                    <TabPanel
                        header="Usuarios"
                        v-if="is('admin|Asistente') && !noEsCliente()"
                    >
                        <PacientesUsuario :usuario="usuario" />
                    </TabPanel>

                    <TabPanel header="Documentos" v-if="is('admin|Asistente')">
                        <div class="card card-bordered">
                            <div class="card-body">
...
<style>
.hero-bg {
    background-image: url("/assets/media/images/bg-1.png");
}
.dark .hero-bg {
