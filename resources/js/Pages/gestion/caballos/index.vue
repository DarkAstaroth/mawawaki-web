          ...
          <div class="row gx-9 h-100">
            ...
            <div class="col-sm-7">
              <div class="d-flex flex-column h-100">
                ...
                <div
                  class="d-flex flex-stack mt-auto bd-highlight justify-content-end"
                >
                  <a
                    :href="route('caballo.detalle', caballo.id)"
...
export default {
  ...
  methods: {
    ...
    cargarCaballos(pagina) {
      const url = "/api/caballos?page=" + pagina + "&busqueda=" + this.busqueda;
      axios
        .get(url)
        .then((response) => {
