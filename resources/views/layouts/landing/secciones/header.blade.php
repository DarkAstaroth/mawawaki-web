            ...
            <div class="container">
                ...
                <div class="d-flex align-items-center justify-content-between">
                    ...
                    <div class="d-flex align-items-center flex-equal">
                        ...
                        <!--begin::Logo image-->
                        <a href="../demo1/landing.html">
                            <img alt="Logo" src="assets/media/logos/logo-scallia.png"
                                class="logo-default h-50px h-lg-50px" />
                            <img alt="Logo" src="assets/media/logos/logo-scallia-light.png"
            ...
            <div class="text-center mb-5 mb-lg-10 py-10 py-lg-20">
                ...
                <h1 class="text-white lh-base fw-bold fs-2x fs-lg-3x mb-15">
                    ...
                    <span
                        ...
                        <span id="kt_landing_hero_text"> impulsan tu éxito.</span>
                    </span>
                </h1>
                <!--end::Title-->

                <!--begin::Action-->
                <a href="../demo1/index.html" class="btn btn-primary">Try Metronic</a>
                <!--end::Action-->
            </div>
            <!--end::Heading-->
