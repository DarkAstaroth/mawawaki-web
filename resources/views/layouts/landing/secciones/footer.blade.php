                  ...
                  <div class="col-lg-6 pe-lg-16 mb-10 mb-lg-0">
                      ...
                      <div class="rounded landing-dark-border p-9">
                          ...
                          <span class="fw-normal fs-4 text-gray-700">
                              ...
                              <a href="../demo1/pages/user-profile/overview.html"
              ...
              <div class="d-flex flex-column flex-md-row flex-stack py-7 py-lg-10">
                  ...
                  <div class="d-flex align-items-center order-2 order-md-1">
                      ...
                      <a href="../demo1/landing.html">
                          <img alt="Logo" src="assets/media/logos/logo-scallia.png" class="h-25px h-md-25px" />
                      </a>
                      <!--end::Logo image-->

                      <!--begin::Logo image-->
                      <span class="mx-5 fs-6 fw-semibold text-gray-600 pt-1" href="https://keenthemes.com">
                          &copy; 2023 Scallia - Software Agency.
                      </span>
                      <!--end::Logo image-->
                  </div>
                  <!--end::Copyright-->
